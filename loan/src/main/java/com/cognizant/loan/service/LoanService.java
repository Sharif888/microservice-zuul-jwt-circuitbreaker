...
public class LoanService {
	...
	public ResponseEntity<Account> getFallBackMethod() throws Exception
	{
		System.out.print("Method cant get data");
		throw new Exception("Cant get data using discovery");
	}
